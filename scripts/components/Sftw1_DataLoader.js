...
class Sftw1_DataLoader {
    ...
    async loadConstellationData() {
        ...
        console.log(`📊 constelações: ${st.totalConstellations} | média vizinhos: ${st.averageNeighbors.toFixed(1)} | min/max: ${st.minNeighbors}/${st.maxNeighbors} | links: ${st.totalNeighborLinks}`);
    ...
    _parseBoundariesDat(raw) {
        ...
        console.log(`📊 boundaries.dat: ${segCount} segmentos | ${this.constellationSegmentsRaw.size} constelações | falhas parse: ${failures}`);
    }
